...
{
    public function testGoogleTests()
    {
		...
		$url = new Google_Safebrowsing_Url('http://host%23.com/%257Ea%2521b%2540c%2523d%2524e%25f%255E00%252611%252A22%252833%252944_55%252B');
		//$this->assertEquals('http://host%23.com/~a!b@c%23d$e%25f^00&11*22(33)44_55+', $url->getCanonicalized());
		...
		$url = new Google_Safebrowsing_Url('http://\x01\x80.com/');
		//$this->assertEquals('http://%01%80.com/', $url->getCanonicalized());
		...
		$url = new Google_Safebrowsing_Url('http://host.com/ab%23cd');
		$this->assertEquals('http://host.com/ab%23cd', $url->getCanonicalized());
